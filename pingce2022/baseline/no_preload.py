...
class Algorithm:
    ...
    def run(self, delay, rebuf, video_size, end_of_video, play_video_id, Players):
        ...
        if end_of_video:
            ...
            buffer_size = Players[0].get_buffer_size()  # ms
            ...
            bit_rate = mpc_module.mpc(self.past_bandwidth, self.past_bandwidth_ests, self.past_errors, self.all_future_chunks_size[0], P, buffer_size, chunk_sum, video_chunk_remain, last_quality)
            sleep_time = 0.0
